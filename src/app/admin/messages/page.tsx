            ...
            {loading ? (
              ...
              msgs.map(m => (
                <div
                  ...
                  className={`flex items-start gap-3 p-4 border-b cursor-pointer transition-colors hover:bg-muted/50 ${
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between">
                      <span className={`text-sm ${!m.is_read ? 'font-bold' : 'font-medium'}`}>
                        {m.name}
                      </span>
