                ...
                products.map((item) => (
                  <tr key={item.id} className="border-b transition-colors hover:bg-muted/50">
                    ...
                    <td className="p-4 align-middle text-right space-x-1">
                      <button onClick={() => navigate({ to: '/admin/products/$id/edit', params: { id: item.id } })} className="inline-flex items-center justify-center rounded-md text-sm transition-colors hover:bg-muted h-9 w-9">
