...
export const Route = createFileRoute("/career")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Build your career with City Steel Corporation — join a team of skilled engineers, fabricators and project managers.",
      },
      { property: "og:title", content: "Career — City Steel Corporation" },
    ],
  }),
