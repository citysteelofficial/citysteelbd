...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Design, fabrication, erection, and full Design & Build packages for industrial steel structures.",
      },
      { property: "og:title", content: "Services — City Steel Corporation" },
    ],
  }),
