  ...
  head: () => ({
    meta: [
      { title: "About Us — City Steel Corporation" },
      {
        name: "description",
        content:
          "Learn about City Steel Corporation — a leading industrial steel structure provider committed to innovation, quality, and client satisfaction.",
      },
      { property: "og:title", content: "About City Steel Corporation" },
